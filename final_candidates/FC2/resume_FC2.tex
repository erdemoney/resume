...
\begin{itemize}
 ...
 \item[$\bullet$] Daily tasks included log monitoring using Proofpoint, LogRhythm, and Rapid7.
 \item[$\bullet$] Maintained extensive technical documentation for scripts and programs developed.
\end{itemize}
\subsection*{Projects}
\begin{itemize}
    \item[$\bullet$] \textbf{PackPlan} - Cross-platform mobile application for collaboratively planning outdoor trips with friends.\\\emph{Implemented using }\textbf{Flutter SDK}\emph{, }\textbf{Firebase Realtime Database}\emph{, }\textbf{Google Places API}\emph{, and }\textbf{OpenWeatherMap API}.
